...
public class Config {
    ...
    public static final String COMETVISU_WEBFOLDER = "runtime/web/";
    
    public static final String COMETVISU_WEBAPP_ALIAS_PROPERTY = "webAlias";
    
    public static final String COMETVISU_WEBAPP_ALIAS = "/cometvisu";
    ...
    static {
//    	iconConfig.put(COMETVISU_ICON_ENABLE_MAPPING_PROPERTY,false);
